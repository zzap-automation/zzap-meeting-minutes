...
async def transcribe(audio: UploadFile = File(...)):
    ...
    MAX_BYTES = 95 * 1024 * 1024  # paid tier supports up to 100 MB
        ...
        try:
            ...
            if len(data) > MAX_BYTES:
                raise HTTPException(
                    ...
                    "Please trim the recording to under ~4 hours and try again."
                )
...
async def generate(
    ...
    max_tokens  = 12000 if detail_level == "detailed" else 8000
